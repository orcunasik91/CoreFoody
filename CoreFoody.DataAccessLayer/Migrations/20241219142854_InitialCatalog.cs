            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReviewId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerName = table.Column<string>(type: "nvarchar(60)", nullable: true),
                    CustomerTitle = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    Comment = table.Column<string>(type: "nvarchar(700)", nullable: true),
                    ImageUrl = table.Column<string>(type: "nvarchar(300)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SocialMediaId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    SocialMediaUrl = table.Column<string>(type: "nvarchar(200)", nullable: true),
                    Icon = table.Column<string>(type: "nvarchar(300)", nullable: true)
                },
                constraints: table =>
                {
